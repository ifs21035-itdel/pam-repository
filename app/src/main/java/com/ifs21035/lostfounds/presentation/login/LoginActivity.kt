package com.ifs21035.lostfounds.presentation.login
...
import com.ifs21035.lostfounds.databinding.ActivityLoginBinding
import com.ifs21035.lostfounds.presentation.ViewModelFactory
import com.ifs21035.lostfounds.presentation.main.MainActivity
import com.ifs21035.lostfounds.presentation.register.RegisterActivity
                ...
                when (result) {
                    ...
                    is MyResult.Error -> {
                        ...
                        AlertDialog.Builder(this).apply {
                            setTitle("Oh No!")
                            setMessage("The credential account is not found!")
                            setPositiveButton("Ok") { _, _ -> }
                            create()
                            show()
                        }
